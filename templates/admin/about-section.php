...
<div class="fsf-version-info" style="position: relative; z-index: 2; font-size: 14px; color: var(--clr-secondary-muted); font-style: italic; font-weight: 400; margin: 20px 0 40px 0; text-align: left;">
...
<div class="fcc-info-toggle-section">
    ...
    <div class="fcc-info-content <?php echo $settings['aboutExpanded'] ? 'expanded' : ''; ?>" id="about-content">
        <div style="color: var(--clr-txt); font-size: 16px; line-height: 1.6;">
            ...
            <div style="background: var(--clr-info-box-bg); padding: 16px 20px; border-radius: var(--rad-md); border-left: 4px solid var(--clr-accent); margin: 20px 80px 0 80px;">

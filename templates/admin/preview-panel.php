        ...
        <div class="fcc-preview-enhanced">
            <div class="fcc-preview-grid">
                <div class="fcc-preview-column">
                    ...
                    <div id="preview-min-container" style="background: var(--clr-white); border-radius: var(--rad-lg); padding: 20px; border: 2px solid var(--clr-secondary); min-height: 320px; box-shadow: inset 0 2px 4px var(--clr-shadow);">
                ...
                <div class="fcc-preview-column">
                    ...
                    <div id="preview-max-container" style="background: var(--clr-white); border-radius: var(--rad-lg); padding: 20px; border: 2px solid var(--clr-secondary); min-height: 320px; box-shadow: inset 0 2px 4px var(--clr-shadow);">
                        <div style="text-align: center; color: var(--clr-txt); font-style: italic; padding: 60px 20px;">
                            <div class="fcc-loading-spinner" style="width: 25px; height: 25px; margin: 0 auto 10px;"></div>
                            <div>Generating space previews...</div>
                        </div>

...
<div style="display: flex; justify-content: center;">
    <div class="fcc-tabs" style="width: 100%; max-width: 600px;">
        ...
        <button id="utils-tab" class="tab-button <?php echo $settings['activeTab'] === 'utils' ? 'active' : ''; ?>" style="flex: 1; padding: 12px 24px; border-radius: 6px; font-size: 16px; font-weight: 600;" data-tab="utils" data-tooltip="Generate Tailwind-style utility classes like .mt-lg, .gap-x-md for margins, padding, and gaps">Utilities (Tailwind)</button>
    </div>
</div>